...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <img src="https://intranet.mondragonmexico.edu.mx/wp-content/uploads/2016/08/IsologoColor_FondoTransparente.png" alt="UMx" width="100" height="100">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-2 md:grid-cols-2 gap-6 lg:gap-6">
                        <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none">
                            <div>
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">COMPETENCIAS TÉCNICAS</h2>
                                
                                <h5 class="mt-4 text-sm font-semibold text-gray-900 dark:text-white">Selecciona una familia</h5>
                                <select id="Select-familia" class="mt-4 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" onchange="mostrarInputOtro('familia')">
                                    <option value="">Seleciona una familia</option>
                                ...
                                <div id="Otro-familia" style="display:none;">
                                    <input type="text" id="input-familia" name="input-familia" placeholder="Especifique otra opción" 
                                    class="mt-4 block w-full py-2 px-3 border border-gray-300 scale-100" style="width: 100%">
                                    <button type="button" onclick="enviarInfo('familia')" id="btn-familia" class="mt-4 py-2 px-4 rounded-full btn">Guardar</button>
                                </div>
                                
                                <h5 class="mt-4 text-sm font-semibold text-gray-900 dark:text-white">Selecciona un sector</h5>

                                <select id="Select-sector" class="mt-4 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" onchange="mostrarInputOtro('sector')">
                                    
                                </select>

                                <div id="Otro-sector" style="display:none;">
                                    <input type="text" id="input-sector" name="input-sector" placeholder="Especifique la opción" 
                                    class="mt-4 block w-full py-2 px-3 border border-gray-300 scale-100" style="width: 100%">
                                    <button type="button" onclick="enviarInfo('sector')" id="btn-sector" class="mt-4 py-2 px-4 rounded-full btn">Guardar</button>
                                </div>
                                
                                <h5 class="mt-4 text-sm font-semibold text-gray-900 dark:text-white">Selecciona una Actividad</h5>

                                <select id="Select-actividad" class="mt-4 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" onchange="mostrarInputOtro('actividad')">
                                    
                                </select>

                                <div id="Otro-actividad" style="display:none;">
                                    <input type="text" id="input-actividad" name="input-actividad" placeholder="Especifique la opción" 
                                    class="mt-4 block w-full py-2 px-3 border border-gray-300 scale-100" style="width: 100%">
    ...
    <script src="{{ asset('js/notyfA.js') }}"></script>
</html>
